...
namespace DollarComputers.DollarComputersDataSet1TableAdapters {
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[products] WHERE (([Id] = @Original_Id) AND ([productID] = @Ori" +
                "ginal_productID) AND ((@IsNull_cost = 1 AND [cost] IS NULL) OR ([cost] = @Origin" +
                "al_cost)) AND ((@IsNull_manufacturer = 1 AND [manufacturer] IS NULL) OR ([manufa" +
                "cturer] = @Original_manufacturer)) AND ((@IsNull_model = 1 AND [model] IS NULL) " +
                "OR ([model] = @Original_model)) AND ((@IsNull_RAM_type = 1 AND [RAM_type] IS NUL" +
                "L) OR ([RAM_type] = @Original_RAM_type)) AND ((@IsNull_RAM_size = 1 AND [RAM_siz" +
                "e] IS NULL) OR ([RAM_size] = @Original_RAM_size)) AND ((@IsNull_displaytype = 1 " +
                "AND [displaytype] IS NULL) OR ([displaytype] = @Original_displaytype)) AND ((@Is" +
                "Null_screensize = 1 AND [screensize] IS NULL) OR ([screensize] = @Original_scree" +
                "nsize)) AND ((@IsNull_resolution = 1 AND [resolution] IS NULL) OR ([resolution] " +
                "= @Original_resolution)) AND ((@IsNull_CPU_Class = 1 AND [CPU_Class] IS NULL) OR" +
                " ([CPU_Class] = @Original_CPU_Class)) AND ((@IsNull_CPU_brand = 1 AND [CPU_brand" +
                "] IS NULL) OR ([CPU_brand] = @Original_CPU_brand)) AND ((@IsNull_CPU_type = 1 AN" +
                "D [CPU_type] IS NULL) OR ([CPU_type] = @Original_CPU_type)) AND ((@IsNull_CPU_sp" +
                "eed = 1 AND [CPU_speed] IS NULL) OR ([CPU_speed] = @Original_CPU_speed)) AND ((@" +
                "IsNull_CPU_number = 1 AND [CPU_number] IS NULL) OR ([CPU_number] = @Original_CPU" +
                "_number)) AND ((@IsNull_condition = 1 AND [condition] IS NULL) OR ([condition] =" +
                " @Original_condition)) AND ((@IsNull_OS = 1 AND [OS] IS NULL) OR ([OS] = @Origin" +
                "al_OS)) AND ((@IsNull_platform = 1 AND [platform] IS NULL) OR ([platform] = @Ori" +
                "ginal_platform)) AND ((@IsNull_HDD_size = 1 AND [HDD_size] IS NULL) OR ([HDD_siz" +
                "e] = @Original_HDD_size)) AND ((@IsNull_HDD_speed = 1 AND [HDD_speed] IS NULL) O" +
                "R ([HDD_speed] = @Original_HDD_speed)) AND ((@IsNull_GPU_Type = 1 AND [GPU_Type]" +
                " IS NULL) OR ([GPU_Type] = @Original_GPU_Type)) AND ((@IsNull_optical_drive = 1 " +
                "AND [optical_drive] IS NULL) OR ([optical_drive] = @Original_optical_drive)) AND" +
                " ((@IsNull_Audio_type = 1 AND [Audio_type] IS NULL) OR ([Audio_type] = @Original" +
                "_Audio_type)) AND ((@IsNull_LAN = 1 AND [LAN] IS NULL) OR ([LAN] = @Original_LAN" +
                ...
                "@IsNull_depth = 1 AND [depth] IS NULL) OR ([depth] = @Original_depth)) AND ((@Is" +
                "Null_weight = 1 AND [weight] IS NULL) OR ([weight] = @Original_weight)) AND ((@I" +
                "sNull_moust_type = 1 AND [moust_type] IS NULL) OR ([moust_type] = @Original_mous" +
                "t_type)) AND ((@IsNull_power = 1 AND [power] IS NULL) OR ([power] = @Original_po" +
                "wer)) AND ((@IsNull_webcam = 1 AND [webcam] IS NULL) OR ([webcam] = @Original_we" +
                "bcam)))";
...
SELECT Id, productID, cost, manufacturer, model, RAM_type, RAM_size, displaytype, screensize, resolution, CPU_Class, CPU_brand, CPU_type, CPU_speed, CPU_number, condition, OS, platform, HDD_size, HDD_speed, GPU_Type, optical_drive, Audio_type, LAN, WIFI, width, height, depth, weight, moust_type, power, webcam FROM products WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[products] SET [Id] = @Id, [cost] = @cost, [manufacturer] = @manufac" +
                "turer, [model] = @model, [RAM_type] = @RAM_type, [RAM_size] = @RAM_size, [displa" +
                "ytype] = @displaytype, [screensize] = @screensize, [resolution] = @resolution, [" +
                "CPU_Class] = @CPU_Class, [CPU_brand] = @CPU_brand, [CPU_type] = @CPU_type, [CPU_" +
                "speed] = @CPU_speed, [CPU_number] = @CPU_number, [condition] = @condition, [OS] " +
                "= @OS, [platform] = @platform, [HDD_size] = @HDD_size, [HDD_speed] = @HDD_speed," +
                " [GPU_Type] = @GPU_Type, [optical_drive] = @optical_drive, [Audio_type] = @Audio" +
                "_type, [LAN] = @LAN, [WIFI] = @WIFI, [width] = @width, [height] = @height, [dept" +
                "h] = @depth, [weight] = @weight, [moust_type] = @moust_type, [power] = @power, [" +
                "webcam] = @webcam WHERE (([Id] = @Original_Id) AND ([productID] = @Original_prod" +
                "uctID) AND ((@IsNull_cost = 1 AND [cost] IS NULL) OR ([cost] = @Original_cost)) " +
                "AND ((@IsNull_manufacturer = 1 AND [manufacturer] IS NULL) OR ([manufacturer] = " +
                "@Original_manufacturer)) AND ((@IsNull_model = 1 AND [model] IS NULL) OR ([model" +
                "] = @Original_model)) AND ((@IsNull_RAM_type = 1 AND [RAM_type] IS NULL) OR ([RA" +
                "M_type] = @Original_RAM_type)) AND ((@IsNull_RAM_size = 1 AND [RAM_size] IS NULL" +
                ") OR ([RAM_size] = @Original_RAM_size)) AND ((@IsNull_displaytype = 1 AND [displ" +
                "aytype] IS NULL) OR ([displaytype] = @Original_displaytype)) AND ((@IsNull_scree" +
                "nsize = 1 AND [screensize] IS NULL) OR ([screensize] = @Original_screensize)) AN" +
                "D ((@IsNull_resolution = 1 AND [resolution] IS NULL) OR ([resolution] = @Origina" +
                "l_resolution)) AND ((@IsNull_CPU_Class = 1 AND [CPU_Class] IS NULL) OR ([CPU_Cla" +
                "ss] = @Original_CPU_Class)) AND ((@IsNull_CPU_brand = 1 AND [CPU_brand] IS NULL)" +
                " OR ([CPU_brand] = @Original_CPU_brand)) AND ((@IsNull_CPU_type = 1 AND [CPU_typ" +
                "e] IS NULL) OR ([CPU_type] = @Original_CPU_type)) AND ((@IsNull_CPU_speed = 1 AN" +
                "D [CPU_speed] IS NULL) OR ([CPU_speed] = @Original_CPU_speed)) AND ((@IsNull_CPU" +
                "_number = 1 AND [CPU_number] IS NULL) OR ([CPU_number] = @Original_CPU_number)) " +
                "AND ((@IsNull_condition = 1 AND [condition] IS NULL) OR ([condition] = @Original" +
                "_condition)) AND ((@IsNull_OS = 1 AND [OS] IS NULL) OR ([OS] = @Original_OS)) AN" +
                "D ((@IsNull_platform = 1 AND [platform] IS NULL) OR ([platform] = @Original_plat" +
                "form)) AND ((@IsNull_HDD_size = 1 AND [HDD_size] IS NULL) OR ([HDD_size] = @Orig" +
                "inal_HDD_size)) AND ((@IsNull_HDD_speed = 1 AND [HDD_speed] IS NULL) OR ([HDD_sp" +
                "eed] = @Original_HDD_speed)) AND ((@IsNull_GPU_Type = 1 AND [GPU_Type] IS NULL) " +
                "OR ([GPU_Type] = @Original_GPU_Type)) AND ((@IsNull_optical_drive = 1 AND [optic" +
                "al_drive] IS NULL) OR ([optical_drive] = @Original_optical_drive)) AND ((@IsNull" +
                "_Audio_type = 1 AND [Audio_type] IS NULL) OR ([Audio_type] = @Original_Audio_typ" +
                "e)) AND ((@IsNull_LAN = 1 AND [LAN] IS NULL) OR ([LAN] = @Original_LAN)) AND ((@" +
                "IsNull_WIFI = 1 AND [WIFI] IS NULL) OR ([WIFI] = @Original_WIFI)) AND ((@IsNull_" +
                "width = 1 AND [width] IS NULL) OR ([width] = @Original_width)) AND ((@IsNull_hei" +
                "ght = 1 AND [height] IS NULL) OR ([height] = @Original_height)) AND ((@IsNull_de" +
                "pth = 1 AND [depth] IS NULL) OR ([depth] = @Original_depth)) AND ((@IsNull_weigh" +
                "t = 1 AND [weight] IS NULL) OR ([weight] = @Original_weight)) AND ((@IsNull_mous" +
                "t_type = 1 AND [moust_type] IS NULL) OR ([moust_type] = @Original_moust_type)) A" +
                "ND ((@IsNull_power = 1 AND [power] IS NULL) OR ([power] = @Original_power)) AND " +
                "((@IsNull_webcam = 1 AND [webcam] IS NULL) OR ([webcam] = @Original_webcam)));\r\n" +
                "SELECT Id, productID, cost, manufacturer, model, RAM_type, RAM_size, displaytype" +
                ", screensize, resolution, CPU_Class, CPU_brand, CPU_type, CPU_speed, CPU_number," +
                " condition, OS, platform, HDD_size, HDD_speed, GPU_Type, optical_drive, Audio_ty" +
                "pe, LAN, WIFI, width, height, depth, weight, moust_type, power, webcam FROM prod" +
                "ucts WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"SELECT Id, productID, cost, manufacturer, model, RAM_type, RAM_size, displaytype, screensize, resolution, CPU_Class, CPU_brand, CPU_type, CPU_speed, CPU_number, condition, OS, platform, HDD_size, HDD_speed, GPU_Type, optical_drive, Audio_type, LAN, WIFI, width, height, depth, weight, moust_type, power, webcam FROM dbo.products";
        ...
        public virtual int Insert1(DollarComputersDataSet1.productsDataTable dataTable) {
